...
<div class="box w-full bg-cover">
    ...
    <div class="flex w-full items-center justify-center pt-20">
        <a class="border-2 border-sky-500 rounded py-2 text-sky-700 px-5 hover:scale-105 transition duration-200 hover:bg-sky-500 hover:text-white" href="/js">Далее</a>
    </div>
</div>
